                        ...
                        <div class="form-validation">
                            ...
                            <form id="create-phim-form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="TenPhong" value="" name="TenPhong" placeholder="Tên Phòng">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="number" id="SoHangGhe" value="" name="SoHangGhe" placeholder="Số Hàng Ghế">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="number" id="SoGheMotHang" value="" name="SoGheMotHang" placeholder="Số Ghế Một Hàng">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
