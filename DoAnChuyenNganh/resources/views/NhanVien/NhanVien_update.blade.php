                        ...
                        <div class="form-validation">
                            ...
                            <form id="create-phim-form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="HoTen" value="{{ $nhanvien[0]->HoTen }}" name="HoTen" placeholder="Tên Nhân Viên">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="date" id="NgaySinh" value="{{$nhanvien[0]->NgaySinh}}" name="NgaySinh" placeholder="Ngày Sinh">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="SDT" value="{{ $nhanvien[0]->SDT }}" name="SDT" placeholder="Số Điện Thoại">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="DiaChi" value="{{$nhanvien[0]->DiaChi}}" name="DiaChi" placeholder="Địa Chỉ">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="Email" value="{{ $nhanvien[0]->Email }}" name="Email" placeholder="Nhập Email">
                                        </div>
                                    </div>
