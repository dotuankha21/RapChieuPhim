                        ...
                        <div class="form-validation">
                            ...
                            <form id="update-phim-form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" type="text" class="form-control text-box single-line" id="TenPhim" value="{{ $phim[0]->TenPhim }}" name="TenPhim" placeholder="Tên Phim">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" type="text" class="form-control text-box single-line" id="MoTa" value="{{ $phim[0]->MoTa}}" name="MoTa" placeholder="Mô Tả">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" type="text" class="form-control text-box single-line" id="ThoiLuong" value="{{ $phim[0]->ThoiLuong }}" name="ThoiLuong" placeholder="Thời Lượng">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" type="text" class="form-control text-box single-line" id="HangSanXuat" value="{{ $phim[0]->HangSanXuat }}" name="HangSanXuat" placeholder="Hãng Sản Xuất">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" type="text" class="form-control text-box single-line" id="DaoDien" value="{{ $phim[0]->DaoDien }}" name="DaoDien" placeholder="Đạo diễn">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" type="text" class="form-control text-box single-line" id="NamSX" value="{{ $phim[0]->NamSX }}" name="NamSX" placeholder="Năm sản xuất">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" type="date" class="form-control text-box single-line" id="NgayKhoiChieu" value="{{ $phim[0]->NgayKhoiChieu }}" name="NgayKhoiChieu" placeholder="Ngày Khởi Chiếu">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="number" id="DonGia" value="{{ $phim[0]->DonGia }}" name="DonGia" placeholder="Nhập Giá">
                                        </div>
                                    </div>
                                </div>
