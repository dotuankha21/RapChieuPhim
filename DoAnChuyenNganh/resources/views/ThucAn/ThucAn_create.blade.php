                        ...
                        <div class="form-validation">
                            ...
                            <form id="create-phim-form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="TENTHUCAN" value="" name="TENTHUCAN" placeholder="Tên Thức Ăn">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="DONGIA" value="" name="DONGIA" placeholder="Đơn Giá">
                                        </div>
                                    </div>
                                </div>
