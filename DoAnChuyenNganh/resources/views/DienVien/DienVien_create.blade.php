                        ...
                        <div class="form-validation">
                            ...
                            <form id="create-phim-form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="TENDV" value="" name="TENDV" placeholder="Tên Diễn Viên">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="MOTA" value="" name="MOTA" placeholder="Mô Tả Diễn Viên">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
