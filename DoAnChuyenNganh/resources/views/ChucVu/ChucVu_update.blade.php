                        ...
                        <div class="form-validation">
                            ...
                            <form id="create-phim-form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input required="required" class="form-control text-box single-line" type="text" id="TenChucVu" value="{{ $chucvu[0]->TenChucVu }}" name="TenChucVu" placeholder="Tên Chức Vụ">
                                        </div>
                                    </div>
                                </div>
