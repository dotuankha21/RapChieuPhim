...
Route::middleware('admin')->group(function(){
    ...
    Route::get('/update_lichchieu/{id}',[LichChieuController ::class,'update'])->name('update_lichchieu');
    ...
    Route::get('/getdanhsachphongtheokhoangtrong_update/{id}/{thoigianchieu}',[LichChieuController::class,'danhSachPhongChieuTrongKhoangThoiGianUpdate'])->name('danhsachphongchieu');
    ...
    /////
    Route::get('/taikhoan',[TaiKhoanController::class,'getDanhSachTaiKhoan']);
    Route::get('/taikhoan/kichhoat/{id}',[TaiKhoanController::class,'kichhoat']);
    Route::get('/taikhoan/vohieuhoa/{id}',[TaiKhoanController::class,'vohieuhoa']);
